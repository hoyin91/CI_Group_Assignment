...
class Individual:
    ...
    def checkConstraint(self, write_to_file=False):
        ...
        if write_to_file:
            f = open(r'P2_constraints.txt', 'a+')
            f.writelines("{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(w, L, d, g1, g2, g3, g4))
            f.close()
...
def main(test_run, generation_count,pop_size):
    ...
    for test in range(test_run):
        ...
        for y in range(generation_count):
            ...
            os.system("echo {} >> result_2_converge.txt".format(fittestoftheloop.getFitness()))
            ...
            os.system("echo {} >> result_final_2.txt".format(fittestoftheloop.getFitness()))
    else:
